...
class ModelArguments:
    ...
    spmd_defer_init: bool = field(
        default=False,
        metadata={"help": ("Use defer init to avoid host-side OOM",)},
    )
    ...
    peft_lora: bool = field(
        default=False,
        metadata={"help": ("Enable LoRA with PEFT")},
    )
...
def main():
    ...
    assert (
        not model_args.spmd_fsdp_sharding or model_args.spmd_2d_sharding == 0
